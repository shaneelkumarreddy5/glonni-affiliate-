...
export default async function WalletPage({ searchParams }: Props) {
  ...
  return <><Header/><main className="wallet-page">
    ...
    <section className="wallet-history">
      ...
      {tab === 'transactions' && <Transactions claims={filteredClaims}/>} {tab === 'withdrawals' && <Withdrawals withdrawals={withdrawals}/>} {tab === 'referrals' && <Referrals/>}
    </section>
...
function Referrals() { return <Empty icon={<CalendarDays/>} title="Referral programme is not active yet" text="Referral rewards will appear here only after Glonni launches an approved referral programme. No referral earnings are being shown before that."/>; }
