...
export default async function Dashboard() {
  ...
  return <main className="admin-v2"><AdminSidebar/><section className="admin-main"><header className="admin-top dashboard-top"><div className="dashboard-top-title"><Activity size={21}/><b>Dashboard</b></div><form action="/admin/analytics"><input name="q" placeholder="Search offers, partners, or activity…" aria-label="Search admin workspace"/></form><span className="dashboard-period">This month</span><span className="dashboard-mode">MOCK MODE · TEST DATA</span><Bell size={19}/><span className="avatar">SR</span><div><b>Shaneel</b><small>Owner</small></div></header><main className="admin-content dashboard-overview"><div className="dashboard-hero"><div><p>BUSINESS OVERVIEW</p><h1>Good morning, Shaneel</h1><span>Your daily Glonni operating picture. Open any panel to review the underlying workspace.</span></div></div>
