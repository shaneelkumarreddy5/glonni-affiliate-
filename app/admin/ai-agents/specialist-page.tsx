...
export const specialistConfigs: Record<string, SpecialistConfig> = {
  ...
  'content-experience': {
    ...
    connectedSummary: 'Content Manager drafts, approved deals, product catalogue and customer-facing store surfaces.',
    ...
    pages: [
      { label: 'Content Manager', detail: 'Deal creative drafts and approval routing', href: '/admin/content-manager' },
  ...
  marketing: {
    ...
    connectedSummary: 'Deal recommendations, Content Manager drafts, Ads Manager, Social Media Manager and channel analytics.',
    ...
    pages: [
      ...
      { label: 'Content Manager', detail: 'Selected deal creative and channel drafts', href: '/admin/content-manager' },
      { label: 'Ads Manager', detail: 'Paid campaign setup and status', href: '/admin/ads' },
      { label: 'Social Media Manager', detail: 'Approved organic posts and publishing queue', href: '/admin/social-manager' },
