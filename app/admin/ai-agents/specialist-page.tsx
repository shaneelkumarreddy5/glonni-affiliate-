...
export const specialistConfigs: Record<string, SpecialistConfig> = {
  ...
  'content-experience': {
    ...
    connectedSummary: 'Content Manager drafts, deals, product catalogue and customer-facing store surfaces.',
  ...
  marketing: {
    ...
    connectedSummary: 'Content Manager drafts, paid ads, ad platforms and social analytics.',
