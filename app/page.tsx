...
export default async function Home() {
  ...
  const homeSections: Record<string, ReactNode> = {
    ...
    'core:stores': <StoreSection/>,
    'core:best_deals': <section id="deals"><div className="section-title"><div><p className="eyebrow">BEST DEALS</p><h2>Best deals right now</h2></div><a href="/deals?sort=best">View all deals</a></div><HomeOfferRail offers={bestDeals.slice(0, 10)} bestDeal/></section>,
    'core:trending': <section><div className="section-title"><div><p className="eyebrow">TRENDING NOW</p><h2>Popular picks across stores</h2></div><a href="/deals?sort=trending">View all trending deals</a></div><HomeOfferRail offers={trending.slice(0, 10)}/></section>,
    'core:price_drops': <section><div className="section-title"><div><p className="eyebrow">PRICE DROPS</p><h2>Worth a closer look</h2></div><a href="/deals?sort=price-drop">View all price drops</a></div><HomeOfferRail offers={priceDrops.slice(0, 10)}/></section>,
    'core:benefits': <section className="benefits">
